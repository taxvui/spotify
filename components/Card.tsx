...
interface CardProps {
  ...
  title: string;
  description: string;
  track?: Track; // If it's a track card or play button target
}
...
export const Card: React.FC<CardProps> = ({ image, title, description, track }) => {
  ...
  return (
    <div className="bg-[#181818] hover:bg-[#282828] p-4 rounded-md transition-colors duration-300 cursor-pointer group flex flex-col gap-4 relative">
