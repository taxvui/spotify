...
const ScrollWrapper = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="flex-1 flex flex-col h-full relative bg-[#121212] rounded-lg overflow-hidden my-2 mr-2">
            ...
            <div 
                ref={scrollRef}
                className="flex-1 overflow-y-auto bg-gradient-to-b from-[#202020] to-[#121212] relative scroll-smooth"
            >
                {children}
            </div>
        </div>
            ...
            <div className="flex flex-col h-screen w-screen bg-black text-white font-sans">
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <ScrollWrapper>
                        ...
                        {/* Fake Footer Links */}
                        <div className="p-8 pb-16 flex flex-col md:flex-row justify-between text-[#b3b3b3] text-sm">
